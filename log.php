        ...
        <div class="card card-registration my-4">
          <div class="row g-0">
            ...
            <CENTER>
		     ...
		     <input type="text" placeholder="Enter contact number" name="t2" class="form-control form-control-lg" required>
		     <br/>
		    ...
		    <br/>
		     ...
		     <a href="rg.php" style="font-size:22px">New Registration</a>
		     <br>
...
if(isset($_REQUEST["sb2"])) {
    ...
    if (!$conn) {
        ...
        $sql = "SELECT cnum, pass FROM regs WHERE cnum = ? AND pass = ?";
        ...
        if (mysqli_stmt_num_rows($stmt) > 0) {
            ...
            header("Location: nav.php"); // Assuming rg.php is the correct page to redirect
            exit();
        } else {
